 ...
 * @author zangyanming
 */
Ext.define('kalix.workflow.meetingRoomApply.controller.MeetingRoomApplyWindowController', {
    extend: 'kalix.controller.BaseWindowController',
    alias: 'controller.meetingRoomApplyWindowController',
    onSave: function () {
        ...
        Ext.Ajax.request({
            async : false,
            url: CONFIG.restRoot + '/camel/rest/meetingroomapplys/check',
            method: 'GET',
            paramsAsJson: true,
            params: {
                'jsonStr':jsonStr
