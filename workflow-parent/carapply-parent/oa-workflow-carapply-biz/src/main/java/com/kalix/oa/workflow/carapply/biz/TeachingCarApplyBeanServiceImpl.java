...
import com.kalix.oa.workflow.carapply.api.biz.ITeachingCarApplyBeanService;
 ...
 * @author hqj
 */
public class TeachingCarApplyBeanServiceImpl extends WorkflowGenericBizServiceImpl<ITeachingCarApplyBeanDao, TeachingCarApplyBean> implements ITeachingCarApplyBeanService {
    ...
    @Override
    public Map getVariantMap(Map map,TeachingCarApplyBean bean) {
        //测试状态机
